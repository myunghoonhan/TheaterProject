        ...
        <nav id="header_navbar_default" class="navbar navbar-default ${param.navbar_style}" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Main.do"> <img class="img_index" alt="Brand" src="src/image/theaterlogo.png"></a>
                </div>
                ...
                <div id="navbar" class="collapse navbar-collapse">
                        ...
                        <li>
                            <form class="navbar-form navbar-right" role="search" method="post" action="SearchTitle.do">
                                <div class="form-group">
                                    <input type="text" name="search" class="form-control" placeholder="The-Ticket을 입력하세요." size="40" required></input>
                                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <c:if test="${sessionScope.id != null }">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"> ${id} 님 <span class="caret"></span></a>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <input type="text" name="id" class="form-control" placeholder="아이디" style="height: 50px" required></input>
                                </div>
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <input type="password" name="pw" class="form-control" placeholder="비밀번호" style="height: 50px" required></input>
                                </div>
                                <div class="col-sm-12">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-xs-9" style="margin-bottom: 10px; padding-right: 3px;">
                                    <input type="text" name="id" class="form-control" placeholder="" required></input>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <input type="password" name="pw" class="form-control" placeholder="" required></input>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="margin-bottom: 25px">
                                    <input type="password" name="pwcheck" class="form-control" placeholder="" required></input>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <input type="text" name="name" class="form-control" placeholder="" required></input>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="margin-bottom: 10px">
                                    <input type="text" name="phone" class="form-control" placeholder="'-'를 제외하고 입력하세요." required></input>
                                </div>
                            </div>
