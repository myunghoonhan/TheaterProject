    ...
    <main>
        ...
        <div class="container">
            ...
            <ul id="index_nav_tabs" class="nav nav-tabs nav-justified" style="margin: 45px 0px 55px 0px;">
                ...
                <li role="presentation" class="dropdown ${active_5}"><a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false"> 지역별 <span class="caret"></span>
                </a>
            ...
            <div id="New_thumblist">
                <h3>
                    "${search}" 검색결과
                    <%-- <span class="badge">${searchTab_count_loc}</span> --%>
                </h3>
                        ...
                        <div class="col-xs-6 col-sm-3">
                            <div class="thumbnail" style="padding: 0px">
                                ...
                                <div class="caption">
                                    ...
                                    <span class="label label-danger" style="font-size: 15px; vertical-align: middle">♥ ${bean.slike}</span> <span style="font-size: 25px; font-weight: 900; color: #d9534f; vertical-align: middle;"> <c:set var="price" value="${bean.sprice }" /> <fmt:formatNumber
                                            type="currency" currencySymbol="" value="${price}" /></span> <span style="font-size: 20px; font-weight: 900; color: #d9534f; vertical-align: middle;"> 원 </span>
                                </div>
                            </div>
                        </div>
